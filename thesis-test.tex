...
%特許分類を用いることより検索する特許文章が減り，似たようなキーワードを含むが分類が違う特許文章を排除することができる．
 ...
 本論文ではNTCIR-6\cite{}の特許文書集合と無効資料検索タスクの質問を用いて評価実験をする．
...
% \end{algorithm}
 ...
 攻撃者が質問者と同様にLDAを用いてメイントピック攻撃する結果が\ref{tab:mt:HDGA}に示す．
 ...
 Maintopic & 51.8 & 46.4 & 42.8 & 32.1 & 32.6 \\
 ...
 図\ref{}は攻撃者がLSAを用いてメイントピック攻撃する結果を表している．
 LDAモデルのトピックとLSAモデルのトピックは一対一に対応できないため，
 LDAモデルでは1つのトピックに集中している質問がLSAモデルの中でも1つのトピックに集中すると限れない．
 デミートピックからランダムに生成したデミー質問は真の質問のように複数の意味分析に対応できる強さを持たない．
