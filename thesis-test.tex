...
\begin{abstract}%%%%%%%%%%%%% 概要 %%%%%%%%
 ...
 本稿では特許検索における既存な質問曖昧化手法\cite{providing2009,embellishing2010,masking2014}を実装し，
...
\end{abstract}
 ...
 \cite{}や\cite{}などのIPアドレスの匿名化メカニズムは登録情報が必要な検索サーバーに対応できないし，
 質問からだけでも質問者のプライバシーが漏洩する危険がある\cite{2006}
 プライベート情報検索\cite{}は計算量的安全性を持つが，サーバー側で大量の計算が必要であるため実用するのは難しい.
