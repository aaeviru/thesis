...
\section{既存研究}
\begin{frame}{Providing Privacy through Plausibly Deniable Search \cite{pang_embellishing_2010}}
	\begin{columns}[t]
		\begin{column}{0.8\textwidth} % 横幅の30％
...
\begin{frame}{Obfuscating the Topical Intention in Enterprise Text Search \cite{pang_embellishing_2010}}
	\begin{columns}[t]
		\begin{column}{0.8\textwidth} % 横幅の30％
			\includegraphics[width=\columnwidth]{rk6.png}
		\end{column}
